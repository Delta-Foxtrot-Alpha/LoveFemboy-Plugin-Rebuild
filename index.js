 (function(c,p,y,d,u,r,w,b){
        ...
        React.createElement(v, null, 
            ...
            React.createElement(F, {
                ...
                onValueChange: function(n) {
                    return r.storage.nsfwwarn = n;
                }
            }), 
            React.createElement(f, {title: "Defalt Sort", titleStyleType: "no_border"}, 
    ...
    function l(n, t, s) {
        const a = n ?? A?.getChannelId?.(),
              i = N.createBotMessage({
                  channelId: a,
                  content: "",
                  embeds: s
              });
              
        i.author.username = "Astolfo";
        i.author.avatar = "Astolfo";
        $.BOT_AVATARS.Astolfo = "https://i.pinimg.com/736x/50/77/1f/50771f45b1c015cfbb8b0853ba7b8521.jpg";
    ...
    m.push(p.registerCommand({
        ...
        execute: async function(n,t){
            try {
                let s = n.find(function(o){return o.name === "nsfw"})?.value,
                    a = n.find(function(o){return o.name === "sort"})?.value,
                    i = n.find(function(o){return o.name === "silent"})?.value;
                
                if (typeof a > "u") a = r.storage.sortdefs;
                
                if (!["best", "hot", "new", "rising", "top", "controversial"].includes(a)) {
                    l(t.channel.id, "Incorrect sorting type. Valid options are\n`best`, `hot`, `new`, `rising`, `top`, `controversial`.", []);
                    return;
                }
                
                // Updated the non-NSFW subreddit to `femboymemes`
                let e = await fetch(`https://www.reddit.com/r/femboymemes/${a}.json?limit=100`).then(function(o){return o.json()});
                
                if (!t.channel.nsfw_ && s && r.storage.nsfwwarn && !(i??!0)) {
                    l(t.channel.id, `This channel is not marked as NSFW\n(You can disable this check in plugin settings)`, []);
                    return;
                }
                
                if (s) {
                    e = await fetch(`https://www.reddit.com/r/femboys/${a}.json?limit=100`).then(function(o){return o.json()});
                }
                ...
                y.logger.log(s);
                l(t.channel.id, "ERROR !!!!!!!!!!!! \u{1F62D}\u{1F62D}\u{1F62D} Check debug logs!! \u{1F97A}\u{1F97A}\u{1F97A}", []);
            }
        }
    }));
